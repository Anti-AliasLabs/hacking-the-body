...
#define WLAN_SSID       "AWR-7200"     //"Up n Jammin" //"whereismycoffee"
#define WLAN_PASS       "hackthebody"  //"moscowdisco" //"x3zsgb4z"
...
const char TOUCH_FEED[] PROGMEM = AIO_USERNAME "/feeds/shoulder/touch";
Adafruit_MQTT_Publish touch = Adafruit_MQTT_Publish(&mqtt, TOUCH_FEED);

// Setup a feed called 'motor' for subscribing to changes.
const char MOTOR_FEED[] PROGMEM = AIO_USERNAME "/feeds/shoulder/motor";
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (subscription == &motor) {
      ...
      // activate motor
      triggerMotor();
      //char* lastChar = (char *)onoffbutton.lastread;
